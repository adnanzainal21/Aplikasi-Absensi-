		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					...
					<b class="text-white">Presensi SMP NEGRI 2 JATIROTO</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Siswa SMP NEGERI 2 JATIROTO (<a href="index.php">Adnan Zainal Arifin </a> | 2021)
					</div>				
				</div>
			</footer>
		</div>
