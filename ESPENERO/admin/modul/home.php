					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Selamat Datang, <b class="text-warning"><?=$data['nama_lengkap']; ?></b> | Aplikasi Siswa SMP NEGERI 2 JATIROTO</h5>
							</div>
							...
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">
										<center>
											<img src="../assets/img/espenero.png" width="100">
											<br>
											<b>SMP NEGERI 2 JATIROTO</b>
										</center>
									</div>
									<div class="card-category">
										<center>
										446G+35V, Cangkring, Kec. Jatiroto, Kabupaten Wonogiri, Jawa Tengah 57692
										</center>
									</div>
